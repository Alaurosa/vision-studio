...
export default function Footer() {
  ...
  return (
    <footer className="mt-32 border-t border-ink-900/10" role="contentinfo">
      <div className="max-w-8xl mx-auto px-6 md:px-10 py-16 grid md:grid-cols-4 gap-10">
        ...
        <nav aria-label="Footer navigation">
          ...
          <ul className="space-y-2 text-sm text-ink-700">
            <li><Link to="/" className="hover:text-ink-900 transition-colors">Home</Link></li>
            <li><Link to="/upload" className="hover:text-ink-900 transition-colors">Upload Floorplan</Link></li>
            <li><Link to="/studio" className="hover:text-ink-900 transition-colors">Design Studio</Link></li>
          </ul>
        </nav>
        <div>
