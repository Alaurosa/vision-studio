  ...
  return (
    <div className="relative">
      ...
      <section className="relative overflow-hidden noise">
        <div className="max-w-8xl mx-auto px-6 md:px-10 pt-24 md:pt-32 pb-20 md:pb-28">
          <motion.p
            initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
            className="eyebrow mb-8"
          >
            Vision Studio · Spatial Intelligence
          </motion.p>
          <motion.h1
            initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9, delay: 0.1 }}
          ...
          >
            ...
            <Link to="/studio" className="btn-ghost">Enter the Studio</Link>
          </motion.div>
        </div>

        {/* Ambient gradient frame */}
        <div aria-hidden className="absolute -bottom-px left-0 right-0 h-px bg-ink-900/10" />
        <div aria-hidden className="absolute inset-x-0 top-0 h-[520px] -z-10 bg-gradient-to-b from-paper-200/40 via-paper-50 to-paper-50" />
      </section>

      {/* TRUSTED BY */}
      <section className="border-t border-b border-ink-900/10 bg-paper-100">
        <div className="max-w-8xl mx-auto px-6 md:px-10 py-10 flex flex-wrap items-center gap-x-12 gap-y-4 text-ink-500">
          <span className="eyebrow">Trusted by studios that ship</span>
          <span className="font-display text-xl tracking-tight">IKEA</span>
          <span className="font-display text-xl tracking-tight italic">Ashley</span>
          <span className="font-display text-xl tracking-tight">Wayfair</span>
          <span className="font-display text-xl tracking-tight italic">Meshy</span>
          <span className="font-display text-xl tracking-tight">OpenAI</span>
        </div>
      </section>
      ...
      <section className="max-w-8xl mx-auto px-6 md:px-10 py-24 md:py-32">
        <div className="grid md:grid-cols-12 gap-10 mb-16">
          <p className="eyebrow md:col-span-3">The Process</p>
          <h2 className="display-lg md:col-span-9 max-w-3xl">
      ...
      <section className="bg-ink-900 text-paper-100">
        <div className="max-w-8xl mx-auto px-6 md:px-10 py-28 md:py-40 grid md:grid-cols-12 gap-10">
          <p className="eyebrow text-paper-400 md:col-span-3">Philosophy</p>
          <blockquote className="md:col-span-9 display-lg text-paper-100 max-w-4xl">
      ...
      <section className="max-w-8xl mx-auto px-6 md:px-10 py-24 md:py-32">
        <div className="grid md:grid-cols-12 gap-10 mb-16">
          <p className="eyebrow md:col-span-3">Our Services</p>
          <h2 className="display-lg md:col-span-9 max-w-3xl">
